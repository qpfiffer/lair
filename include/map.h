 ...
 */
int _tst_map_insert(_tst_map_node **root, const char *key, const size_t klen, const void *value, const size_t vsize);
 ...
 */
int _tst_map_delete(_tst_map_node *root, const char *key, const size_t klen);
